...
##### Safe Implementation 
Wrap code with `#if UNITY_EDITOR` and use `EditorApplication.delayCall` to execute complex UI or resource operations or it will .
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMTM1NDU4NTUsNzM0MzExMjExLC02Nj
