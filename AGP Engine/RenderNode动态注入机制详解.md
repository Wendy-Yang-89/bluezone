...
```cpp
// intf_render_node_graph_manager.h:98-113
struct RenderNodeDependency {
    ...
    RenderDataConstants::RenderDataFixedString typeName;  // 依赖目标节点的类型名称
...
**位置**: `Lume3D/src/util/render_util.cpp:185-199`
...
```cpp
// Lume3D/src/util/render_util.cpp:235-252
...
**InjectRenderNodes**: `Lume3D/src/util/render_util.cpp:220-267`

**GetRenderNodesWithDependencies**: `Lume3D/src/util/render_util.cpp:185-199`